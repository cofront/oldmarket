...
<div class="not-found">
    <h1 class="numbers">
        <strong>4</strong>
        <span>
            <i class="fa fa-exclamation-triangle ui-text-danger animated zoomIn"></i>
        </span>
        <strong>4</strong>
    </h1>
    <p class="text-center animated fadeInUp"><strong>Oppps! Page Not Found!</strong></p>
    <p class="text-center animated fadeInUp">The page you are looking for can't be found.</p>
    <p class="animated fadeInUp"><a href="index.jsp" class="ui-btn ui-btn-info btn-shadow">Back to Homepage</a></p>
</div>
<!--end 404 section-->
