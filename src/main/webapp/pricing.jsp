...
<head>
    ...
    <title>OldsMarket Pricing</title>
    <!--stylesheets-->
...
<div class="pricing-wrapper">
    <h1>Flexible pricing <span class="ui-text-info">Plans</span> for Everyone</h1>
    <div class="pricing-boxes">
        <div class="pricing-box">
            <i class="fa fa-gift ui-text-info fa-4x"></i>
            <h3>StartUp</h3>
            <p>
                <span>List Up to 10 Items/Month</span>
                <span>Pay 10% Loyalty/Item Sold</span>
            </p>
            <div>
                <h1 class="ui-text-info">$49</h1>
                <a href="#" class="ui-btn ui-btn-info">Free Trial</a>
            </div>
        </div>
        <div class="pricing-box">
            <i class="fa fa-briefcase ui-text-success fa-4x"></i>
            <h3>Medium</h3>
            <p>
                <span>List Up to 96 Items/Month</span>
                <span>Pay 8% Loyalty/Item Sold</span>
            </p>
            <div>
                <h1 class="ui-text-success">$99</h1>
                <a href="#" class="ui-btn ui-btn-success">Free Trial</a>
            </div>
        </div>
        <div class="pricing-box">
            <i class="fa fa-star-half-empty ui-text-info fa-4x"></i>
            <h3>Ultimate</h3>
            <p>
                <span>List Up to 200 Items/Month</span>
                <span>Pay 5% Loyalty/Item Sold</span>
            </p>
            <div>
                <h1 class="ui-text-info">$136</h1>
                <a href="#" class="ui-btn ui-btn-info">Free Trial</a>
            </div>
        </div>
    </div>
...
<div class="start-here">
    ...
    <div class="divide">
        <a href="login-register.jsp" class="ui-btn ui-btn-info">Sign In</a>
        <strong class="ui-text-success">Or</strong>
        <a href="login-register.jsp" class="ui-btn ui-btn-prim">Register</a>
    </div>
</div>
<!--end start here-->
