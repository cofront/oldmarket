    ...
    <div class="dash-messages list-page">
        <div class="messages-list">
            ...
            <ul class="list-unstyled msg-items">
                <li class="msg-item">
                    <a class="current" href="http://oldsmarket.neonweb.me/message-detail.jsp">
                        <strong>Khalim Sayon</strong>
                        <span>Lorem ipsum dolor amet</span>
                        <em>09:23 a.m</em>
                    </a>
                </li>
                <li class="msg-item">
                    <a href="http://oldsmarket.neonweb.me/message-detail.jsp">
                        <strong>Khalim Sayon</strong>
                        <span>Lorem ipsum dolor amet</span>
                        <em>12:45 p.m</em>
                    </a>
        ...
        <div class="message-details">
            <div class="msg-top-strip">
                <div class="msg-actions">
                    <a href="#"><i class="fa fa-pencil"></i> <span>New Message</span></a>
                    <div class="icon-act">
                        <i title="Favourite" class="fa fa-star-o"></i>
                        <i title="Archive" class="fa fa-archive"></i>
            ...
            <div class="msg">
                <div class="sender-info">
                    ...
                    <p><strong>Brandon Zeus</strong><span>12 Jan, 2017</span></p>
                </div>
                <h5 class="msg-title">Proposal For Web Development</h5>
                <p class="message-info">
                    Salami tail chuck, ground round ham hock jerky hamburger
                    t-bone spare ribs leberkas. Turducken pork belly lebe
                    rkas kielbasa, boudin pig pork chop beef ribs cupim
                    hamburger sausage. Pancetta drumstick ham meatloaf
                    tongue brisket. Tri-tip ham picanha doner capicola
                    jerky, ribeye brisket ground round pig shankle burgdoggen.
                    <br>
                    <br>
                    Salami tail chuck, ground round ham hock jerky hamburger
                    t-bone spare ribs leberkas. Turducken pork belly lebe
                    ...
                    <br>
                    <br>
                    Pancetta drumstick ham meatloaf
                    tongue brisket. Tri-tip ham picanha doner capicola
                    jerky, ribeye.
                </p>
                <p class="thanks">
                    <strong>Thanks</strong><br>
                    <span>Awesomed Team</span>
                </p>
                ...
                <form action="#" method="post" class="reply-frm">
                    <div class="form-group">
                        <textarea required name="msg" rows="5" class="form-control" placeholder="Write something cool!"></textarea>
                    </div>
                    <div class="form-action">
                        <label for="attach"><i class="fa fa-file-o"></i> Attach File<input id="attach" type="file"></label>
                        <button type="submit"><i class="fa fa-send-o"></i> Reply</button>
                    </div>
                </form>
            </div>
        </div>
